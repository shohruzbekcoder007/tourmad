...
const FavouriteTwo: React.FC = () => {
  ...
  return (
    <Box>
      {wishList &&
        wishList[0]?.user_restaurant_wishes?.map((item, index) => {
          return (
            <Paper
              key={index}
              elevation={1}
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src={item?.restaurant?.banner || card_image}
                    width="100%"
                    alt=""
                    style={{
                      borderRadius: "16px",
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {item?.restaurant?.rate} {t("Star Restaurant")}
                          </GlobalParagraph>
                        </Box>
                        {/* <Box
                          display="flex"
                      ...
                      <Box
                        ...
                        marginTop="12px"
                      >
                        <Button variant="outlined">{item?.restaurant?.grade}</Button>
                        <GlobalParagraph
                          fontSize="12px"
                          mediafontsize="10px"
                          fontWeight="700"

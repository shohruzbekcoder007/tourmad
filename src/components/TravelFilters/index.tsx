  ...
  return (
    <Stack>
      ...
      <Box display="flex" justifyContent="space-between">
                  ...
                  {[0, 1, 2, 3].map((value) => {
                    ...
                    return (
                      <ListItem key={value} disablePadding>
                        <ListItemButton
                          role={undefined}
                          onClick={handleToggleAirlines(value)}
                          dense
                        >
                          <ListItemIcon>
                            <Checkbox
                  ...
                  {[0, 1, 2, 3].map((value) => {
                    ...
                    return (
                      <ListItem key={value} disablePadding>
                        <ListItemButton
                          role={undefined}
                          onClick={handleToggleTrips(value)}
                          dense
                        >
                          <ListItemIcon>
                            <Checkbox
        ...
        <Divider
          sx={{ display: { xl: "block", md: "block", sm: "none", xs: "none" } }}
        ...
        <Box width={{ xl: "792px", md: "68%", sm: "100%", xs: "100%" }}>
          ...
          >
            ...
            <Box
              ...
              width={{ xl: "250px", md: "250px", sm: "250px", xs: "200px" }}
            >

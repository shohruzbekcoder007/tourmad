          ...
          <FooterBottom>
            ...
            <FooterLink>
              ...
              <ul typeof="none">
                <li>
                  <FooterList>
                    <Link to="/protected">{t("Trip Advisor")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/my-driver">{t("My Driver")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/consulting">{t("Consulting")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
            ...
            <FooterLink>
              ...
              <ul typeof="none">
                <li>
                  <FooterList>
                    <Link to="/protected/daily">{t("Daily")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/protected/hotel">{t("Hotel")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/protected/ticket">{t("Ticket")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/protected/restaurant">{t("Restaurant")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/protected/drive">{t("Driver")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/protected/plan">{t("Plan")}</Link>
                  </FooterList>
                </li>
                <li>
                  <FooterList>
                    <Link to="/protected/map">{t("Map")}</Link>
                  </FooterList>
                </li>
              </ul>
            </FooterLink>

...
const HotelCard: React.FC<HotelCardProps> = ({ id, card, galery, grade, name, location, room_style, rate }) => {
      ...
      <Box display="flex" justifyContent="space-between" flexWrap="wrap">
        ...
        <Box mt={{ xl: 0, md: 0, sm: 0, xs: "24px" }} width={{ xl: '65%', md: "65%", sm: "65%", xs: "100%" }}>
          ...
          <Box pb="12px" display="flex" alignItems="center" justifyContent="flex-start" gap="2px">
            ...
            <GlobalParagraph fontSize="12px" fontWeight="500">{grade} {t("Star Hotel")}</GlobalParagraph>
          </Box>
          ...
          <Box pt="16px" display="flex" justifyContent="space-between">
            ...
            <Box width={{ xl: "85%", md: "75%", sm: "75%", xs: "75%" }}>
              <Button onClick={() => navigate(`/hotel-detail/${id}`)} variant="contained" fullWidth>
                {t("View Deals")}
              </Button>
            </Box>
          </Box>
